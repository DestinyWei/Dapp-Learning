...
- Get Link test coins 
Every time you go to ChainLink to request VRF random number, you need to consume Link coins. Therefore, you need to apply for Link test coins before the test. For the sepolia test network, go to [Request testnet LINK](https://faucets.chain.link/sepolia?_ga=2.35440098.2104755910.1637393798-1377742816.1635817935) , Then "Netwrok" selects "Ethereum sepolia" and "Testnet Account Address "enters the account address corresponding to PRIVATE_KEY in the **.env** file
...
chainlink sepolia faucet: https://faucets.chain.link/sepolia?_ga=2.35440098.2104755910.1637393798-1377742816.1635817935  
