...
1. Deploy an `ERC20` contract
   Deploying by using `depoly.js`. In this demo, we use the test network `sepolia` to deploy the contract, and we need to use an account with Ether to send the transaction.
