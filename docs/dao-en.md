...
- The test cases under the script directory can be successfully debugged on the sepolia network (recommended), and the test cases under the test directory can be successfully debugged even on the local node
